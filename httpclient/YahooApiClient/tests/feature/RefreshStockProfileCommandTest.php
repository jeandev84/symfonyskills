...
use App\Http\Client\FakeYahooFinanceApiClient;
...
class RefreshStockProfileCommandTest extends DatabaseDependantTestCase
{
    ...
    public function the_refresh_stock_profile_command_updates_existing_records_correctly()
    {
        ...
        $stock->setRegion('US');
        $stock->setExchangeName('NasdaqG5');
        ...
        /* dd(FakeYahooFinanceApiClient::$content); */
        ...
        $this->assertEquals(3172.69, $stockRecord->gePreviousClose());
        $this->assertEquals(3258.7083, $stockRecord->gePrice());
        $this->assertEquals(86.02, $stockRecord->gePreviousChange());
        ...
        // Check no duplicates i.e. i record instead of 2
