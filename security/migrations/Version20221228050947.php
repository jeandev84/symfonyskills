 ...
 */
final class Version20221228050947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account (id INT NOT NULL, account_holder_id INT NOT NULL, account_manager_id INT NOT NULL, balance DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account DROP CONSTRAINT FK_7D3656A484A5C6C7');
